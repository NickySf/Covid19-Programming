      ...
      while (i <= people) {
        ...
        switch (result) {
          ...
          case "positive":
            ...
            /*Patient's Contacts' Data insert in variables, through calling
             * the methods of the class Imports*/
            for (int j = 1; j <= potinf; j++) {
              ...
              PotenciallyInfected a3 = new PotenciallyInfected(
                  name, surname, age, gender, phone, email, amka);
            }
      ...
      switch (a1.theStatistics()) {
        ...
        case 1:
          ...
          System.out.println("The total number"
              + " of patients right now is " + a4.totalPatients() + " patients");
          System.out.println(" ");
          System.out.println(" ");
          a4.statsPerArea();
          a4.stats2PerArea();
