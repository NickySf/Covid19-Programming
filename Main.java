...
public class Main {
	...
	public static void main(String[] args) {
		...
		while (end == 0) {
			...
			int people = wi.imports1(mess);

			// Number of patients that took the test at this hospital//
			...
			/*
			 * Patient's Data insert in variables, through calling the methods of the class
			 * Imports
			 */
			...
			while (i <= people) {
				...
				case "positive":
					...
					/*
					 * Patient's Contacts' Data insert in variables, through calling the methods of
					 * the class Imports
					 */
					...
					for (int j = 1; j <= potinf; j++) {
						...
						PotenciallyInfected a3 = new PotenciallyInfected(name, surname, age, gender, phone, email,
								amka);
					}
